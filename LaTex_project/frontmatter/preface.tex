...
Aplicando balanceo uniforme a todos los rangos se consiguen mejoras significativas en la proporción de predicciones clínicamente aceptables tanto para la hipoglucemia severa como para la hipoglucemia. En TBR$_2$, los aumentos fueron de 63.75, 76.81 y 75.93 puntos porcentuales, respectivamente, para los tres datasets, observándose también mejoras significativas en TBR$_1$. Aunque los errores de regresión aumentaron moderadamente a nivel global, la aceptabilidad clínica global mejoró en los tres datasets. En TIR, las predicciones clínicamente aceptables permanecieron por encima del 99\%, sin que ninguna predicción entrara en las zonas D o E de la cuadrícula de Clarke. La hiperglucemia severa también mejoró, mientras que el balanceo completo produjo un pequeño deterioro localizado en la hiperglucemia moderada. En resumen, este trabajo demuestra que, equilibrando la distribución de los rangos glucémicos, se puede mejorar sustancialmente la predicción en rangos minoritarios clínicamente críticos, manteniendo al mismo tiempo un elevado rendimiento clínico a nivel global.
...
\begin{center}
    {\large\bfseries
    Compensating for Glycemic Ranges Heterogeneity in Glucose Prediction
...
Full balancing of all glycemic ranges significantly increased the proportion of clinically acceptable predictions in both severe hypoglycemia and hypoglycemia. In TBR$_2$, the mean improvements were 63.75, 76.81, and 75.93 percentage points across the three datasets, with significant improvements also observed in TBR$_1$. Although conventional regression errors moderately increased globally, global clinical acceptability improved in all three datasets. In TIR, clinically acceptable predictions remained above 99\%, with no predictions entering Clarke Zones D or E. Severe hyperglycemia also improved, while full balancing introduced a small localized deterioration in moderate hyperglycemia. Overall, the study demonstrates that modifying the glycemic distribution of the training data can substantially improve prediction in clinically critical minority ranges while preserving strong global clinical performance.
...
\begin{flushright}
Granada, a \textbf{1} de \textbf{Septiembre} de 2026.
\end{flushright}
...
\textbf{Ingeniería de Computadores, Automática y Robótica} de la Universidad de Granada.
...
\textbf{Ingeniería de Computadores,
Automática y Robótica} de la Universidad de Granada.
...
\textit{\textbf{Compensating for Glycemic Ranges Heterogeneity in Glucose
...
\textbf{1} de \textbf{Septiembre} de 2026.
...
A mis padres, Rafa y Teo. Por enseñarme, con su ejemplo, el valor del esfuerzo. Por darme alas, y un refugio al que volver. Por darme más de lo que nunca podré devolver.

A mi hermana, Inés. Por incondicional. Por ser casa. Por compartir el camino, incluso cuando cada uno seguía el suyo.

A Paty. Por caminar a mi lado. Por ayudarme a ser mejor. Por enseñarme que las cosas importantes también se construyen con esfuerzo, paciencia y constancia.

A todas las personas que, de una forma u otra, me han acompañado durante estos años. Este trabajo supone el cierre de una etapa importante de mi vida, y no habría sido la misma sin vosotros.
