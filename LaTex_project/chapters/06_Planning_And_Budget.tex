...
\begin{itemize}
    \item \textbf{Weeks~0--3} were dedicated to the theoretical foundations: review of the state of the art, comprehension of the clinical context of Type 1 Diabetes, and study of clinical evaluation methods such as the Clarke Error Grid.
