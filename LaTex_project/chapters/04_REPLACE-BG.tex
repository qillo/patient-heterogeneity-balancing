...
As the central part of the EDA for this thesis, glycemic ranges (see Table~\ref{tab:glycemic_range_metrics}) distribution of REPLACE-BG dataset was also studied. Results are presented summarised in Table~\ref{tab:replace_bg_glycemic_distribution}
