...
\begin{itemize}
    ...
    \item TBR numerical and clinical performance (\textit{althouh TBR2 clinical performance will be addressed as the primary outcome};
