...
\begin{table}[htbp]
    ...
    \begin{tabular}{lr}
        ...
        Female patients & 112 \\
        \hline
        Mean days with measurements per patient & 172.95 \\
        Median days with measurements per patient & 178 \\
        \hline
        Mean measurements per patient & 46,570.37 \\
        Median measurements per patient & 48,475 \\
        \hline
    \end{tabular}
\end{table}
